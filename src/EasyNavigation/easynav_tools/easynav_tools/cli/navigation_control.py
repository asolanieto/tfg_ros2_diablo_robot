...
from ..controller.ros_controllers import EasyNavControlProcessor


class NavigationControlVerb(VerbExtension):
    """Print Navigation Control info for a given duration."""
    ...
    def control_callback(self, msg):
        raw_text = EasyNavControlProcessor.msg2text(msg)
    ...
    def main(self, *, args):
        with NodeStrategy(args) as node:
            try:
                navigation_control_sub = EasyNavControlProcessor(node, self.control_callback)
                navigation_control_sub
