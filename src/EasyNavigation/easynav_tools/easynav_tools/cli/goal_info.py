...
from ..controller.ros_controllers import GoalManagerInfoProcessor


class GoalInfoVerb(VerbExtension):
    """Print Goal info for a given duration."""
    ...
    def goal_info_callback(self, msg):
        raw_text = GoalManagerInfoProcessor.msg2text(msg)
    ...
    def main(self, *, args):
        with NodeStrategy(args) as node:
            try:
                goal_info_sub = GoalManagerInfoProcessor(node, self.goal_info_callback)
                goal_info_sub
